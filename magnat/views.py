...
from .serializers import ClientModelSerializer, MediaModelSerializer, WorkerModelSerializer, CommentModelSerializer, BlogModelSerializer
from .models import Mijoz, Portfolio, Hodim, Comment, Blog
